...
<body>
	...
	<div class="main-inner" id="mainCnt"
		...
		<div id="loginBlock" class="login"
			...
			<div class="loginForm">
				<s:form action="user_login" namespace="/" id="loginform" name="loginform" method="post" cssClass="niceform">
					<s:actionerror/>
					<div id="idInputLine" class="loginFormIpt showPlaceholder"
						style="margin-top: 5px;">
						<s:textfield name="username" id="loginform:idInput" cssClass="loginFormTdIpt" maxlength="50" />	
						<label for="idInput" class="placeholder" id="idPlaceholder">帐号：</label>
					</div>
					<div class="forgetPwdLine"></div>
					<div id="pwdInputLine" class="loginFormIpt showPlaceholder">
						<s:password name="password" id="loginform:pwdInput" cssClass="loginFormTdIpt" />	

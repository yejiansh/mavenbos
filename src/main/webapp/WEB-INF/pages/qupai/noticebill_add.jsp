...
<script type="text/javascript">
	$(function(){
		...
		$("input[name='telephone']").blur(function(){
			// 发送Ajax请求，到服务器，获取客户信息
			$.post("${pageContext.request.contextPath}/noticebill_findCustomerByPhone.action"
					, {"telephone":$(this).val()}, function(data){
				if(data == null){
				   // 重置			
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div region="center" style="overflow:auto;padding:5px;" border="false">
		<form id="noticebillForm" 
			action="${pageContext.request.contextPath }/noticebill_save.action" method="post">

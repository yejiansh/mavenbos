...
<script type="text/javascript">
	...
	function doExport(){
		...
		location.href = "${pageContext.request.contextPath}/subarea_export.action?"+param;
	}
					...
					<tr>
						...
						<td>
							<input class="easyui-combobox" name="region.id"  
    							...
    							url:'${pageContext.request.contextPath }/region_ajaxlist.action',mode:'remote'" />  
						</td>
					</tr>
					<tr>
						<td>关键字</td>
						<td><input type="text" name="addresskey" class="easyui-validatebox" data-options="required:true"/></td>
					</tr>
					<tr>
						<td>起始号</td>
